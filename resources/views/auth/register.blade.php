...
@section('content')
    <div class="mx-auto h-full flex justify-center items-center bg-gray-300">
        <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
            ...
            <h5 class="text-blue-300 pt-2">Enter your details below</h5>
            ...
            <form
                ...
                <div class="relative">
                    <label for="name"
                           class="absolute uppercase text-blue-500 text-xs font-bold pl-3 pt-2">Name</label>
                    <input class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700"
                           ...
                           autofocus placeholder="Your name" required>
                    @error('name')
