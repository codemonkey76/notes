<template>
    <div class="h-screen bg-white">
        <div class="flex flex-col md:flex-row">
            <div class="pl-6 bg-gray-200 md:w-32 md:h-screen border-b-2 md:border-b-0 md:border-r-2 border-gray-400">
                <nav class="md:block flex items-center py-4">
                    <router-link to="/">
                        <svg class="fill-current text-blue-600 w-12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
